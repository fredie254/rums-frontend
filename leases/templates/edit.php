...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        $res2 = $api->put("lease-templates/$id", [
            'name'       => $name,
    ...
    // Pre-fill from fetched template
    $_POST['name']       = $tpl['name'];
    $_POST['lease_type'] = $tpl['lease_type'];
    $_POST['body']       = $tpl['body'];
    $_POST['is_default'] = $tpl['is_default'] ? '1' : '';
}
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="lease_type" class="form-select">
                                ...
                                <option value="<?= $lt ?>" <?= post('lease_type') === $lt ? 'selected':'' ?>>
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <div class="form-check mb-2">
                                ...
                                <label class="form-check-label fw-semibold" for="isDefault">Default</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body p-0">
                    <textarea name="body" id="templateBody" class="form-control border-0 rounded-0 font-monospace"
                              rows="24" style="resize:vertical"><?= e(post('body')) ?></textarea>
                </div>
            </div>
